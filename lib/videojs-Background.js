...
(function(window, videojs) {
  ...
  function init(settings, player) {
    ...
    var def = ' ' +
      '.videojs-background-wrap .video-js.vjs-controls-disabled .vjs-poster { background-size: 100%!important; background-size: cover!important; display: block!important; }' +
